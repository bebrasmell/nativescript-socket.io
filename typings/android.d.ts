  ...
  export module socket {
    export module emitter {
      export class Emitter {
        ...
        public on(
          param0: string,
          param1: io.socket.emitter.Emitter.Listener,
        ): io.socket.emitter.Emitter;
        public listeners(
          param0: string,
        ): java.util.List<io.socket.emitter.Emitter.Listener>;
        public once(
          param0: string,
          param1: io.socket.emitter.Emitter.Listener,
        ): io.socket.emitter.Emitter;
      ...
      export module Emitter {
        ...
        export class OnceListener extends io.socket.emitter.Emitter.Listener {
          ...
          public constructor(
            param0: io.socket.emitter.Emitter,
            param1: string,
            param2: io.socket.emitter.Emitter.Listener,
          );
          public call(param0: native.Array<any>): void;
        }
      }
    ...
    export module engineio {
      export module client {
        export class Socket extends io.socket.emitter.Emitter {
          ...
          public constructor(
            param0: java.net.URI,
            param1: io.socket.engineio.client.Socket.Options,
          );
          public static setDefaultOkHttpCallFactory(
            param0: okhttp3.Call.Factory,
          ): void;
          public write(param0: native.Array<number>): void;
          public send(param0: string): void;
          public constructor(param0: string);
          public static setDefaultOkHttpWebSocketFactory(
            param0: okhttp3.WebSocket.Factory,
          ): void;
        ...
        export module Socket {
          export class Options extends io.socket.engineio.client.Transport
            .Options {
            ...
            public host: string;
            public query: string;
            public transportOptions: java.util.Map<
              string,
          ...
          export class ReadyState {
            ...
            public static valueOf(
              param0: string,
            ): io.socket.engineio.client.Socket.ReadyState;
    ...
    export module engineio {
      export module client {
        export abstract class Transport extends io.socket.emitter.Emitter {
          ...
          public write(
            param0: native.Array<io.socket.engineio.parser.Packet<any>>,
          ): void;
          public constructor(
            param0: io.socket.engineio.client.Transport.Options,
          );
    ...
    export module engineio {
      export module client {
        export module transports {
          export abstract class Polling extends io.socket.engineio.client
            .Transport {
...
declare module io {
  export module socket {
    export module engineio {
      export module client {
        export module transports {
          export class PollingXHR extends io.socket.engineio.client.transports
            .Polling {
            ...
            public constructor();
            public request(
              param0: io.socket.engineio.client.transports.PollingXHR.Request.Options,
          ...
          export module PollingXHR {
            ...
            export module Request {
              export class Options {
                ...
                public data: string;
                public callFactory: okhttp3.Call.Factory;
                public extraHeaders: java.util.Map<
                  string,
      ...
      export module parser {
        export class Packet<T> extends java.lang.Object {
          public static class: java.lang.Class<
            io.socket.engineio.parser.Packet<any>
          >;
      ...
      export module parser {
        export class Parser {
          ...
          public static decodePacket(
            param0: string,
          ): io.socket.engineio.parser.Packet<string>;
          public static encodePayload(
            param0: native.Array<io.socket.engineio.parser.Packet<any>>,
            param1: io.socket.engineio.parser.Parser.EncodeCallback<string>,
          ): void;
          public static decodePayload(
            param0: string,
            param1: io.socket.engineio.parser.Parser.DecodePayloadCallback<string>,
          ): void;
          public static encodePacket(
            param0: io.socket.engineio.parser.Packet<any>,
            param1: io.socket.engineio.parser.Parser.EncodeCallback<any>,
          ): void;
          public static decodePacket(
            param0: native.Array<number>,
          ): io.socket.engineio.parser.Packet<native.Array<number>>;
          public static decodeBase64Packet(
            param0: string,
          ): io.socket.engineio.parser.Packet<any>;
        }
        export module Parser {
          export class DecodePayloadCallback<T> extends java.lang.Object {
            public static class: java.lang.Class<
              io.socket.engineio.parser.Parser.DecodePayloadCallback<any>
            >;
            /**
            ...
            public constructor(implementation: {
              call(
                param0: io.socket.engineio.parser.Packet<T>,
                param1: number,
                param2: number,
              ): boolean;
            });
          ...
          export class EncodeCallback<T> extends java.lang.Object {
            public static class: java.lang.Class<
              io.socket.engineio.parser.Parser.EncodeCallback<any>
            >;
            /**
             ...
             */
            public constructor(implementation: { call(param0: T): void });
            public constructor();
