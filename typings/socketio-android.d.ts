    ...
    export module client {
      export class IO {
        ...
        public static socket(
          param0: string,
          param1: io.socket.client.IO.Options,
  ...
  export module socket {
    export module client {
      export class Manager {
        ...
        public open(
          param0: io.socket.client.Manager.OpenCallback,
        ...
        public socket(
          param0: string,
          param1: io.socket.client.Manager.Options,
        ): io.socket.client.Socket;
        public constructor(
          param0: java.net.URI,
          param1: io.socket.client.Manager.Options,
  ...
  export module socket {
    export module client {
      export class Socket {
        ...
        public constructor(
          param0: io.socket.client.Manager,
          param1: string,
          param2: io.socket.client.Manager.Options,
        );
        public connect(): io.socket.client.Socket;
        public close(): io.socket.client.Socket;
        public io(): io.socket.client.Manager;
        public off(e: string, listener?: any): void;
        public once(e: string, listener: any): void;
        public on(e: string, listener: any): void;
      }
    }
  }
}
  ...
  export module socket {
    export module client {
      export class Url {
        ...
        public static parse(
          param0: java.net.URI,
        ): io.socket.client.Url.ParsedURI;
      }
      export module Url {
  ...
  export module socket {
    export module parser {
      export class Binary {
        ...
        public static deconstructPacket(
          param0: io.socket.parser.Packet<any>,
        ): io.socket.parser.Binary.DeconstructedPacket;
        public static reconstructPacket(
          param0: io.socket.parser.Packet<any>,
          param1: native.Array<native.Array<number>>,
        ): io.socket.parser.Packet<any>;
        public constructor();
      }
    ...
    export module parser {
      ...
      export module IOParser {
        ...
        export class Decoder extends io.socket.parser.Parser.Decoder {
          ...
          public onDecoded(
            param0: io.socket.parser.Parser.Decoder.Callback,
          ): void;
        }
        export class Encoder extends io.socket.parser.Parser.Encoder {
          ...
          public encode(
            param0: io.socket.parser.Packet<any>,
            param1: io.socket.parser.Parser.Encoder.Callback,
          ): void;
        }
      }
    }
