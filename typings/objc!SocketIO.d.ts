...
declare class SocketEngine extends NSObject implements NSURLSessionDelegate {
  ...
  URLSessionWithSessionDidBecomeInvalidWithError(
    session: NSURLSession,
    error: NSError,
  ): void;
  ...
  writeWithTypeWithDataCompletion(
    msg: string,
    type: SocketEnginePacketType,
    data: NSArray<NSData> | NSData[],
    completion: () => void,
  ): void;
}
...
interface SocketEngineClient {
  ...
  engineDidWebsocketUpgradeWithHeaders(
...
declare const SocketEngineClient: {
...
declare class SocketIOClient extends NSObject {
  ...
  connectWithPayloadTimeoutAfterWithHandler(
    payload: NSDictionary<string, any>,
    timeoutAfter: number,
    handler: () => void,
  ): void;

  didConnectToNamespacePayload(
    namespace_: string,
    payload: NSDictionary<string, any>,
  ): void;
  ...
  handleEventDataIsInternalMessageWithAck(
    event: string,
    data: NSArray<any> | any[],
  ...
  onCallback(
    event: string,
    callback: (p1: NSArray<any>, p2: SocketAckEmitter) => void,
  ): NSUUID;
...
declare let SocketIOVersionNumber: number;

declare let SocketIOVersionString: interop.Reference<number>;
...
declare class SocketManager extends NSObject implements SocketEngineClient {
  ...
  initWithSocketURLConfig(
    socketURL: NSURL,
    config: NSDictionary<string, any>,
  ): this;
